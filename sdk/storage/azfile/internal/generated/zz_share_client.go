...
// AcquireLease - The Lease Share operation establishes and manages a lock on a share for delete operations. The lock duration
...
func (client *ShareClient) acquireLeaseCreateRequest(ctx context.Context, options *ShareClientAcquireLeaseOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=lease"
...
// BreakLease - The Lease Share operation establishes and manages a lock on a share for delete operations. The lock duration
// can be 15 to 60 seconds, or can be infinite.
// If the operation fails it returns an *azcore.ResponseError type.
//   - options - ShareClientBreakLeaseOptions contains the optional parameters for the ShareClient.BreakLease method.
func (client *ShareClient) BreakLease(ctx context.Context, options *ShareClientBreakLeaseOptions) (ShareClientBreakLeaseResponse, error) {
	var err error
...
func (client *ShareClient) breakLeaseCreateRequest(ctx context.Context, options *ShareClientBreakLeaseOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=lease"
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
...
// ChangeLease - The Lease Share operation establishes and manages a lock on a share for delete operations. The lock duration
// can be 15 to 60 seconds, or can be infinite.
// If the operation fails it returns an *azcore.ResponseError type.
...
// CreatePermission - Create a permission (a security descriptor). This is used to support file level ACLs for SMB shares.
// If the operation fails it returns an *azcore.ResponseError type.
...
func (client *ShareClient) CreatePermission(ctx context.Context, permission SharePermission, options *ShareClientCreatePermissionOptions) (ShareClientCreatePermissionResponse, error) {
	var err error
	req, err := client.createPermissionCreateRequest(ctx, permission, options)
	if err != nil {
...
func (client *ShareClient) createPermissionCreateRequest(ctx context.Context, permission SharePermission, options *ShareClientCreatePermissionOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=filepermission"
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
	}
...
func (client *ShareClient) createSnapshotCreateRequest(ctx context.Context, options *ShareClientCreateSnapshotOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=snapshot"
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
	}
...
func (client *ShareClient) Delete(ctx context.Context, options *ShareClientDeleteOptions) (ShareClientDeleteResponse, error) {
	var err error
...
func (client *ShareClient) deleteCreateRequest(ctx context.Context, options *ShareClientDeleteOptions) (*policy.Request, error) {
	urlPath := "?restype=share"
...
// GetAccessPolicy - Returns information about stored access policies specified on the share that may be used with Shared
// Access Signatures.
// If the operation fails it returns an *azcore.ResponseError type.
//   - options - ShareClientGetAccessPolicyOptions contains the optional parameters for the ShareClient.GetAccessPolicy method.
func (client *ShareClient) GetAccessPolicy(ctx context.Context, options *ShareClientGetAccessPolicyOptions) (ShareClientGetAccessPolicyResponse, error) {
	var err error
...
func (client *ShareClient) getAccessPolicyCreateRequest(ctx context.Context, options *ShareClientGetAccessPolicyOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=acl"
...
// GetPermission - Returns the permission (security descriptor) for a given permission key. This is used to support file level
// ACLs for SMB shares.
// If the operation fails it returns an *azcore.ResponseError type.
//   - filePermissionKey - Key of the permission to be set for the directory/file. Note: Only one of the x-ms-file-permission
...
func (client *ShareClient) GetProperties(ctx context.Context, options *ShareClientGetPropertiesOptions) (ShareClientGetPropertiesResponse, error) {
	var err error
...
func (client *ShareClient) getPropertiesCreateRequest(ctx context.Context, options *ShareClientGetPropertiesOptions) (*policy.Request, error) {
	urlPath := "?restype=share"
	req, err := runtime.NewRequest(ctx, http.MethodGet, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
...
func (client *ShareClient) GetStatistics(ctx context.Context, options *ShareClientGetStatisticsOptions) (ShareClientGetStatisticsResponse, error) {
	var err error
...
func (client *ShareClient) getStatisticsCreateRequest(ctx context.Context, options *ShareClientGetStatisticsOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=stats"
	req, err := runtime.NewRequest(ctx, http.MethodGet, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
	}
...
// ReleaseLease - The Lease Share operation establishes and manages a lock on a share for delete operations. The lock duration
// can be 15 to 60 seconds, or can be infinite.
// If the operation fails it returns an *azcore.ResponseError type.
//   - leaseID - Specifies the current lease ID on the resource.
...
// RenewLease - The Lease Share operation establishes and manages a lock on a share for delete operations. The lock duration
// can be 15 to 60 seconds, or can be infinite.
// If the operation fails it returns an *azcore.ResponseError type.
//   - leaseID - Specifies the current lease ID on the resource.
...
func (client *ShareClient) restoreCreateRequest(ctx context.Context, options *ShareClientRestoreOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=undelete"
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
	}
...
// SetAccessPolicy - Sets stored access policies for the share that may be used with Shared Access Signatures.
// If the operation fails it returns an *azcore.ResponseError type.
...
func (client *ShareClient) SetAccessPolicy(ctx context.Context, shareACL []*SignedIdentifier, options *ShareClientSetAccessPolicyOptions) (ShareClientSetAccessPolicyResponse, error) {
	var err error
	req, err := client.setAccessPolicyCreateRequest(ctx, shareACL, options)
	if err != nil {
...
func (client *ShareClient) setAccessPolicyCreateRequest(ctx context.Context, shareACL []*SignedIdentifier, options *ShareClientSetAccessPolicyOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=acl"
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
...
func (client *ShareClient) SetMetadata(ctx context.Context, options *ShareClientSetMetadataOptions) (ShareClientSetMetadataResponse, error) {
	var err error
...
func (client *ShareClient) setMetadataCreateRequest(ctx context.Context, options *ShareClientSetMetadataOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=metadata"
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
	}
...
func (client *ShareClient) SetProperties(ctx context.Context, options *ShareClientSetPropertiesOptions) (ShareClientSetPropertiesResponse, error) {
	var err error
...
func (client *ShareClient) setPropertiesCreateRequest(ctx context.Context, options *ShareClientSetPropertiesOptions) (*policy.Request, error) {
	urlPath := "?restype=share&comp=properties"
	req, err := runtime.NewRequest(ctx, http.MethodPut, runtime.JoinPaths(client.url, urlPath))
	if err != nil {
		return nil, err
	}
